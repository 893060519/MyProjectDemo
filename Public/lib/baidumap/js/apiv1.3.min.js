window.BMAP_AUTHENTIC_KEY = ""; (function() {
    ...
    var cd = {
        imgPath : "Public/lib/baidumap/images/",
        cityNames: {
            "\u5317\u4eac": "bj",
            "\u4e0a\u6d77": "sh",
            "\u6df1\u5733": "sz",
    ...
    a9.object.extend(cB, {
        ...
        preLoaded: {},
        Config: {
            _baseUrl: "Public/lib/baidumap/js/",
            //x + "getmodules?v=1.3",
            _timeout: 5000
        },
        delayFlag: false,
                ...
                if (T._status == this.Request.INITIAL) {
                    ...
                    if (cN.delayFlag == false) {
                        ...
                        window.setTimeout(function() {
                            var cP = cN.Config._baseUrl + "/modules" // "&mod=" + cN.Module._arrMdls.join(",");
                            cy.request(cP);
    ...
    aU.getTilesUrl = function(cN, cQ) {
        ...
        //		  + (cR + "").replace(/-/gi, "M") + "&y="
        //		  + (cO + "").replace(/-/gi, "M") + "&z="
        // 	  + cQ + "&styles=" + cP + (a9.browser.ie == 6 ? "&color_dep=32&colors=50": "") 
        //  	  + "&udt=" + T;
        cM = "Public/lib/baidumap/map/maptile/" + cQ + "/" + cR + "/" + cO + ".jpg";
    ...
    bR.getTilesUrl = function(cM, cO) {
        var cP = cM.x;
        var cN = cM.y;
        var T = b8[Math.abs(cP + cN) % b8.length] + "u=x=" + cP + ";y=" + cN + ";z=" + cO + ";v=009;type=sate&fm=46";
        return T.replace(/-(\d+)/gi, "M$1")
    };
