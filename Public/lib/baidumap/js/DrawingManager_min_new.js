...
//BMAP_LEFT_SHIFT = "left";
//BMAP_RIGHT_SHIFT = "right";
//BMAP_LESSEN = "lessen";
//BMAP_MAGNIFY = "magnify";
(function() {
    ...
    DrawingManager.prototype._initialize = function(map, opts) {
         ...
         * @type {DrawingType}
         */
        this._drawingType = opts.drawingMode || BMAP_DRAWING_CIRCLE; //点改为圆
        /**
         * 是否添加添加鼠标绘制工具栏面板
         */
    ...
    DrawingManager.prototype._setDrawingMode = function(drawingType) {
      ...
      //      case BMAP_LESSEN:
	     ...
	     //   	this._magnify();
	     //   	break;
	     //   case BMAP_LEFT_SHIFT:
		    //    this._leftshift();
		    //    break;
		    //case BMAP_RIGHT_SHIFT:
			   // this._rightshift();
			   // break;
            }
        }
	 ...
	 *绑定地图缩小级别的事件
	 */
	/*DrawingManager.prototype._lessen = function(){
		var me = this,
        map = this._map,
        mask = this._mask;
	...
	*绑定地图增大级别的事件
	*/
	/*DrawingManager.prototype._magnify = function(){
		var me = this,
        map = this._map,
        mask = this._mask;
		var click = function(e) {
	 ...
	 *绑定地图向左移动的事件
	*/
	/*DrawingManager.prototype._leftshift = function() {
		var me = this,
        map = this._map,
        mask = this._mask;
		var click = function(e) {
	...
	*绑定地图向右移动的事件
	*/
	/*DrawingManager.prototype._rightshift = function() {
		var me = this,
        map = this._map,
        mask = this._mask;
		var click = function(e) {
    ...
    DrawingManager.prototype._addGeoUtilsLibrary = function() {
        if (!BMapLib.GeoUtils) {
            ...
            script.setAttribute("src", 'js/JSonline/GeoUtils_min.js');
    ...
    DrawingTool.prototype._generalHtml = function(map) {
        ...
        //tips[BMAP_LESSEN] = "缩小一级";
        //tips[BMAP_MAGNIFY] = "扩大一级";
        //tips[BMAP_LEFT_SHIFT] = "地图向左平移";
        //tips[BMAP_RIGHT_SHIFT] = "地图向右平移";
        ...
        for (var i = 0,
        len = this.drawingModes.length; i < len; i++) {
